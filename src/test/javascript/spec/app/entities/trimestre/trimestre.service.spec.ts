    ...
    describe('Trimestre Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/trimestres';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Trimestre', () => {
                service.create(new Trimestre(null)).subscribe(received => {
            ...
            it('should update a Trimestre', () => {
                service.update(new Trimestre(123)).subscribe(received => {
