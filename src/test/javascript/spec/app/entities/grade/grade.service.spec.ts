    ...
    describe('Grade Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/grades';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Grade', () => {
                service.create(new Grade(null)).subscribe(received => {
            ...
            it('should update a Grade', () => {
                service.update(new Grade(123)).subscribe(received => {
