    ...
    describe('Prime Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/primes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Prime', () => {
                service.create(new Prime(null)).subscribe(received => {
            ...
            it('should update a Prime', () => {
                service.update(new Prime(123)).subscribe(received => {
