    ...
    describe('Avancement Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/avancements';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Avancement', () => {
                service.create(new Avancement(null)).subscribe(received => {
            ...
            it('should update a Avancement', () => {
                service.update(new Avancement(123)).subscribe(received => {
