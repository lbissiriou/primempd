    ...
    describe('Fonction Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/fonctions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Fonction', () => {
                service.create(new Fonction(null)).subscribe(received => {
            ...
            it('should update a Fonction', () => {
                service.update(new Fonction(123)).subscribe(received => {
