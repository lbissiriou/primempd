...
describe('Service Tests', () => {
    describe('Corps Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CorpsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/corps';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Corps', () => {
                service.create(new Corps(null)).subscribe(received => {
            ...
            it('should update a Corps', () => {
                service.update(new Corps(123)).subscribe(received => {
