    ...
    describe('Direction Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/directions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Direction', () => {
                service.create(new Direction(null)).subscribe(received => {
            ...
            it('should update a Direction', () => {
                service.update(new Direction(123)).subscribe(received => {
