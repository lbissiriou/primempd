...
describe('Service Tests', () => {
    describe('Annee Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AnneeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/annees';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Annee', () => {
                service.create(new Annee(null)).subscribe(received => {
            ...
            it('should update a Annee', () => {
                service.update(new Annee(123)).subscribe(received => {
