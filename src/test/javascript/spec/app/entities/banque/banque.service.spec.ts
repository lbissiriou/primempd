    ...
    describe('Banque Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/banques';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Banque', () => {
                service.create(new Banque(null)).subscribe(received => {
            ...
            it('should update a Banque', () => {
                service.update(new Banque(123)).subscribe(received => {
