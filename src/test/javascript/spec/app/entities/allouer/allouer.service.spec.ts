    ...
    describe('Allouer Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/allouers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Allouer', () => {
                service.create(new Allouer(null)).subscribe(received => {
            ...
            it('should update a Allouer', () => {
                service.update(new Allouer(123)).subscribe(received => {
